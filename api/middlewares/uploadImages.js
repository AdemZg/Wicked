...
const multerStorage = multer.diskStorage({ destination: function(req, file, cb){
...
const uploadImg = multer({ storage: multerStorage, filterFilter: multerFilter, limits: { fileSize: 2000000 } })
